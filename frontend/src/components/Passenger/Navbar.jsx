      ...
      <div className="ms-auto d-flex align-items-center gap-4">
        ...
        <div className="position-relative">
          ...
          >
            ...
            <div>
              <p className="m-0 fw-semibold" style={{ fontSize: '0.9rem' }}>{user?.fullName || 'Passenger'}</p>
              <p className="m-0 text-muted" style={{ fontSize: '0.75rem' }}>{user?.role || 'Passenger'}</p>
            </div>
          </div>
            ...
            <>
              ...
              >
                <div className="px-3 py-2 border-bottom">
                  <p className="m-0 fw-semibold" style={{ fontSize: '0.85rem' }}>{user?.fullName || 'Passenger'}</p>
                ...
                <button
                  ...
                  onClick={() => { setShowDropdown(false); navigate('/passenger/profile'); }}
